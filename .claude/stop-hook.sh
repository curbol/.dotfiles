#!/bin/bash
# Temp workaround: stop hook to nudge Claude to keep working when it tries to
# quit early or dodge ownership. Based on https://gist.github.com/benvanik/ee00bd1b6c9154d6545c63e06a317080
