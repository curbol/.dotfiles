...
TMUX_OUTER_BACKGROUND_COLOR=$GRUVBOX_MATERIAL_ORANGE
TMUX_OUTER_FOREGROUND_COLOR=$GRUVBOX_MATERIAL_GREY2
...
if [ -z "$TMUX_POWERLINE_LEFT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
		"custom_mode ${TMUX_OUTER_BACKGROUND_COLOR} ${TMUX_OUTER_FOREGROUND_COLOR}"
		"tmux_session_info ${GRUVBOX_MATERIAL_GREY3} ${GRUVBOX_MATERIAL_GREY5}"
		# "hostname"
		# "pwd 89 211"
	)
fi
...
if [ -z "$TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		# "date_day 235 136"
		# "date default ${GRUVBOX_MATERIAL_YELLOW} ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN} default ${GRUVBOX_MATERIAL_GREY5}"
		"custom_weather default default ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN} default default"
		"custom_session_info ${GRUVBOX_MATERIAL_GREY3} ${GRUVBOX_MATERIAL_GREY5}"
		"time ${TMUX_OUTER_BACKGROUND_COLOR} ${TMUX_OUTER_FOREGROUND_COLOR}"
